...
export function AppFrame({
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{ position: "relative", background: T.cream, border: `1px solid ${T.creamBorder}`, borderRadius: 16, boxShadow: "0 50px 100px -40px rgba(15,23,42,.45)", overflow: "hidden" }}>
