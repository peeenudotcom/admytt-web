...
export default function AICommandCentre() {
  ...
  return (
    <section id="ai" style={{ background: "linear-gradient(160deg,#0B1230 0%,#161a52 100%)", padding: "92px 0", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -80, right: -60, width: 360, height: 360, borderRadius: "50%", background: "radial-gradient(circle,#2453D4 0%,transparent 70%)", opacity: 0.4 }} />
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px", position: "relative" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }} data-ai="1">
          <div>
            ...
            <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#fff", marginBottom: 16 }}>AI that does the work, not the talking</h2>
          ...
          <div ref={sceneRef} onMouseEnter={onEnter} onMouseLeave={onLeave} onFocusCapture={onEnter} onBlurCapture={onLeave} style={{ background: "#fff", borderRadius: 14, overflow: "hidden", boxShadow: "0 30px 70px -28px rgba(0,0,0,.6)" }}>
            <div style={{ background: "#161a52", padding: "12px 16px", display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ width: 30, height: 30, borderRadius: 8, background: "#2453D4", display: "flex", alignItems: "center", justifyContent: "center", font: "700 13px var(--font-manrope)", color: "#fff", flexShrink: 0 }}>AI</span>
              <div style={{ font: "700 13px var(--font-manrope)", color: "#fff", flex: 1, minWidth: 0 }}>Operational briefing</div>
              <span style={pillDark}>
              ...
              {scanning ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 11, padding: "26px 0" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 9, font: "600 13.5px var(--font-inter)", color: "#475569" }}>
                    <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#2453D4", animation: "adpulse 1s infinite" }} />
                    Scanning today&apos;s work…
                  </div>
                  <div style={{ height: 6, borderRadius: 999, background: "#EEF2F8", overflow: "hidden", position: "relative" }}>
                    <div style={{ position: "absolute", top: 0, left: 0, height: "100%", width: "32%", background: "#2453D4", borderRadius: 999, animation: "adscan 1.1s infinite" }} />
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    <div style={selected ? alertSel : alertBase}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                        <div style={{ font: "700 13px var(--font-manrope)", color: "#0B1230" }}>3 leads at risk of going cold</div>
                    ...
                    <div style={fade(as >= 3)}>
                      <div style={{ background: "#FBE9E9", borderLeft: "3px solid #CB0000", borderRadius: 8, padding: "13px 15px" }}>
                        <div style={{ font: "700 13px var(--font-manrope)", color: "#0B1230" }}>Priya Sharma — missing financial document</div>
                    ...
                    <div style={fade(as >= 4)}>
                      <div style={{ background: "#E6F6EF", borderLeft: "3px solid #0F9F6E", borderRadius: 8, padding: "13px 15px" }}>
                        <div style={{ font: "700 13px var(--font-manrope)", color: "#0B1230" }}>Application risk: low across 37 files</div>
                    ...
                    <div style={{ overflow: "hidden", transition: "max-height .5s ease,opacity .4s", maxHeight: as >= 6 ? 230 : 0, opacity: as >= 6 ? 1 : 0 }}>
                      <div style={{ border: "1px solid #E4EAF3", borderRadius: 9, padding: "13px 14px", background: "#F8FAFE" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 9 }}>
                          <span style={{ width: 22, height: 22, borderRadius: 6, background: "#212177", color: "#fff", font: "700 10px var(--font-manrope)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>AI</span>
                          <span style={{ font: "700 12px var(--font-manrope)", color: "#0B1230" }}>Drafting follow-up</span>
                        ...
                        {draftReady && (
                          <>
                            ...
                            <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                              <button style={{ font: "700 11.5px var(--font-inter)", color: "#fff", background: "#2453D4", border: "none", borderRadius: 7, padding: "8px 14px", cursor: "pointer" }}>Review draft</button>
                    ...
                    {showStatement && (
                      <div style={{ display: "flex", alignItems: "center", gap: 9, background: "#EEF0FF", borderRadius: 8, padding: "11px 13px", font: "700 12.5px var(--font-inter)", color: "#212177" }}>
                        <span style={{ color: "#2453D4" }}>◆</span>AI suggests. Your team decides.
                      </div>
                    )}
                  </div>
                )
