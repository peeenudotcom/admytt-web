...
export default function Hero() {
  ...
  return (
    <section id="top" style={{ position: "relative", overflow: "hidden", background: "radial-gradient(120% 120% at 80% -10%,#F0F4FE 0%,#F6F8FC 55%)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.02fr .98fr", gap: 48, alignItems: "center" }} data-hero="1">
          ...
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 9, background: "#fff", border: "1px solid #E1E8F4", borderRadius: 999, padding: "6px 13px 6px 8px", font: "600 12.5px var(--font-inter)", color: "#334155", marginBottom: 24 }}>
              <span style={{ background: "#EAF0FF", color: "#2453D4", borderRadius: 999, padding: "2px 8px", font: "700 11px var(--font-inter)" }}>CRM</span>
              Built for education consultancies, not adapted for them
            </div>
            <h1 data-h1 style={{ font: "800 53px/60px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 18 }}>
              <Link href="#demo" onClick={() => track("hero_demo_clicked", { location: "hero" })} style={{ font: "700 15.5px var(--font-manrope)", color: "#fff", textDecoration: "none", background: "#2453D4", padding: "15px 28px", borderRadius: 8, boxShadow: "0 10px 24px rgba(36,83,212,.3)" }}>
                Book a demo
              </Link>
              <Link href="/product" style={{ font: "700 15.5px var(--font-manrope)", color: "#0B1230", textDecoration: "none", background: "#fff", border: "1px solid #DCE3EE", padding: "15px 26px", borderRadius: 8 }}>
                See the product
              </Link>
            </div>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ position: "absolute", inset: "18px -40px -30px 0", background: "linear-gradient(135deg,#212177,#2453D4)", borderRadius: 18, opacity: 0.1, transform: "rotate(2deg)" }} />
            <div
              ref={sceneRef}
            ...
            >
              <div style={{ height: 40, background: "#0B1230", display: "flex", alignItems: "center", gap: 7, padding: "0 12px" }}>
                <span style={{ width: 9, height: 9, borderRadius: "50%", background: "#CB0000" }} />
              ...
              <div style={{ display: "flex", minHeight: 360, position: "relative" }}>
                <div data-hsb="1" style={{ width: 56, background: "#161a52", display: "flex", flexDirection: "column", alignItems: "center", gap: 7, padding: "14px 0", flexShrink: 0 }}>
                  <span style={{ width: 26, height: 26, borderRadius: 7, background: "#2453D4", display: "flex", alignItems: "center", justifyContent: "center", font: "700 12px var(--font-manrope)", color: "#fff" }}>a</span>
                ...
                <div style={{ flex: 1, padding: "16px 18px", position: "relative", minWidth: 0 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                    <div>
                      <div style={{ font: "700 14px var(--font-manrope)", color: "#0B1230" }}>Leads · Today&apos;s work</div>
                    ...
                    <button style={{ font: "700 10.5px var(--font-inter)", color: "#fff", background: hs === 2 ? "#1c3aa0" : "#2453D4", border: "none", borderRadius: 7, padding: "5px 11px", cursor: "pointer", transform: `scale(${hs === 2 ? 0.92 : 1})`, transition: "transform .15s,background .15s" }}>+ Add lead</button>
                  </div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 9, marginBottom: 12 }}>
                    <div style={{ background: "#F6F8FC", border: "1px solid #EAEFF7", borderRadius: 9, padding: 10 }}>
                      <div style={{ font: "800 21px var(--font-manrope)", color: "#0B1230" }}>{hs >= 6 ? "129" : "128"}</div>
                      <div style={{ font: "500 10.5px var(--font-inter)", color: "#64748B" }}>Open leads</div>
                    </div>
                    <div style={{ background: "#F6F8FC", border: "1px solid #EAEFF7", borderRadius: 9, padding: 10 }}>
                      <div style={{ font: "800 21px var(--font-manrope)", color: "#2453D4" }}>37</div>
                      <div style={{ font: "500 10.5px var(--font-inter)", color: "#64748B" }}>Applications</div>
                    </div>
                    <div style={{ background: "#F6F8FC", border: "1px solid #EAEFF7", borderRadius: 9, padding: 10 }}>
                      <div style={{ font: "800 21px var(--font-manrope)", color: "#CB0000" }}>6</div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    <div style={{ overflow: "hidden", transition: "max-height .45s ease,opacity .4s,margin .4s", maxHeight: hs >= 6 ? 150 : 0, opacity: hs >= 6 ? 1 : 0, marginBottom: hs >= 6 ? 8 : 0 }}>
                      <div style={{ background: "#fff", border: "1px solid #9bbcf5", borderRadius: 9, padding: "10px 11px", boxShadow: "0 0 0 3px rgba(36,83,212,.12)" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <span style={{ width: 30, height: 30, borderRadius: "50%", background: "#E6F6EF", color: "#0F9F6E", font: "700 12px var(--font-manrope)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>RM</span>
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ font: "600 12.5px var(--font-inter)", color: "#0B1230" }}>Rahul Mehta</div>
                            <div style={{ font: "500 10.5px var(--font-inter)", color: "#94a3b8" }}>Undergraduate · Canada</div>
                          </div>
                          <span style={{ font: "600 10px var(--font-inter)", color: "#2453D4", background: "#EAF0FF", borderRadius: 999, padding: "3px 9px", flexShrink: 0 }}>New enquiry</span>
                        </div>
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 8, paddingLeft: 40 }}>
                          {hs >= 7 && <span style={{ font: "600 10px var(--font-inter)", color: "#212177", background: "#EEF0FF", borderRadius: 999, padding: "3px 8px" }}>Owner · Aisha Khan</span>}
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, background: "#fff", border: "1px solid #EAEFF7", borderRadius: 9, padding: "9px 11px" }}>
                      <span style={{ width: 30, height: 30, borderRadius: "50%", background: "#EAF0FF", color: "#2453D4", font: "700 12px var(--font-manrope)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>PS</span>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ font: "600 12.5px var(--font-inter)", color: "#0B1230" }}>Priya Sharma</div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, background: "#fff", border: "1px solid #EAEFF7", borderRadius: 9, padding: "9px 11px" }}>
                      <span style={{ width: 30, height: 30, borderRadius: "50%", background: "#FBE9E9", color: "#CB0000", font: "700 12px var(--font-manrope)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>AK</span>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ font: "600 12.5px var(--font-inter)", color: "#0B1230" }}>Arjun Kapoor</div>
                  ...
                  {showForm && (
                    <div style={{ position: "absolute", left: 14, right: 14, top: 72, background: "#fff", border: "1px solid #DCE3EE", borderRadius: 11, boxShadow: "0 24px 50px -18px rgba(11,18,48,.42)", padding: "15px 16px", zIndex: 6 }}>
                      <div style={{ font: "700 13px var(--font-manrope)", color: "#0B1230", marginBottom: 11 }}>New lead</div>
                      <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                        <div>
                          <div style={{ font: "600 9.5px var(--font-inter)", color: "#94a3b8", marginBottom: 3 }}>Full name</div>
                          <div style={{ height: 30, border: "1px solid #E4EAF3", borderRadius: 7, display: "flex", alignItems: "center", padding: "0 10px", font: "600 12px var(--font-inter)", color: "#0B1230" }}>{hs >= 4 ? "Rahul Mehta" : ""}</div>
                        </div>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 9 }}>
                          <div>
                            <div style={{ font: "600 9.5px var(--font-inter)", color: "#94a3b8", marginBottom: 3 }}>Destination</div>
                            <div style={{ height: 30, border: "1px solid #E4EAF3", borderRadius: 7, display: "flex", alignItems: "center", padding: "0 10px", font: "600 12px var(--font-inter)", color: "#0B1230" }}>{hs >= 4 ? "Canada" : ""}</div>
                          </div>
                          <div>
                            <div style={{ font: "600 9.5px var(--font-inter)", color: "#94a3b8", marginBottom: 3 }}>Source</div>
                            <div style={{ height: 30, border: "1px solid #E4EAF3", borderRadius: 7, display: "flex", alignItems: "center", padding: "0 10px", font: "600 12px var(--font-inter)", color: "#0B1230" }}>{hs >= 4 ? "Website form" : ""}</div>
                          </div>
                        </div>
                        <button style={{ font: "700 11px var(--font-inter)", color: "#fff", background: hs === 5 ? "#1c3aa0" : "#2453D4", border: "none", borderRadius: 7, padding: "9px 0", width: "100%", cursor: "pointer", transform: `scale(${hs === 5 ? 0.96 : 1})`, transition: "transform .15s" }}>Create lead</button>
                      </div>
                    </div>
                  )}

                  {hs >= 10 && (
                    <div style={{ position: "absolute", left: 14, right: 14, bottom: 12, background: "#0B1230", borderRadius: 10, padding: "11px 14px", display: "flex", alignItems: "center", gap: 10, boxShadow: "0 16px 34px -14px rgba(11,18,48,.5)", zIndex: 7 }}>
                      <span style={{ width: 22, height: 22, borderRadius: "50%", background: "#0F9F6E", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", font: "700 12px var(--font-manrope)", flexShrink: 0 }}>✓</span>
              ...
              <div style={{ position: "absolute", zIndex: 9, left: C.l, top: C.t, opacity: C.o, transform: `scale(${C.s})`, transition: "left .55s cubic-bezier(.5,0,.2,1),top .55s cubic-bezier(.5,0,.2,1),opacity .3s,transform .18s", pointerEvents: "none" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M5 3l13 6.5-5.4 1.6L9.6 18z" fill="#0B1230" stroke="#fff" strokeWidth="1.4" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div style={{ position: "absolute", bottom: -22, left: -26, background: "#fff", border: "1px solid #E4EAF3", borderRadius: 11, boxShadow: "0 16px 34px -12px rgba(11,18,48,.28)", padding: "11px 14px", display: "flex", alignItems: "center", gap: 10 }} data-float="1">
              <span style={{ width: 34, height: 34, borderRadius: 9, background: "#212177", display: "flex", alignItems: "center", justifyContent: "center", font: "700 14px var(--font-manrope)", color: "#fff" }}>AI</span>
              <div>
                <div style={{ font: "700 12px var(--font-manrope)", color: "#0B1230" }}>Auto-assigned to Aisha Khan</div>
  ...
  return (
    <div style={{ maxWidth: 1240, margin: "60px auto 0", padding: "0 28px" }}>
      <div style={{ borderTop: "1px solid #E4EAF3", padding: "30px 0 40px", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 22 }} data-trust="1">
        {items.map((it) => (
          <div key={it.title}>
            <div style={{ font: "700 15px var(--font-manrope)", color: "#0B1230", marginBottom: 5 }}>{it.title}</div>
