...
export function Problem() {
  return (
    <section style={{ background: "#F6F8FC", padding: "92px 0" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ maxWidth: 680, marginBottom: 40 }}>
          <div style={{ font: "700 13px var(--font-inter)", color: "#2453D4", marginBottom: 12 }}>The cost of disconnected tools</div>
          <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 14 }}>When the student record lives in ten places, work falls through the gaps</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22 }} data-ba="1">
          <div style={{ background: "#fff", border: "1px solid #E9DADA", borderRadius: 14, padding: 30 }}>
            <div style={{ font: "700 13px var(--font-inter)", color: "#CB0000", marginBottom: 16 }}>Before adMYTT</div>
            <div style={{ display: "flex", flexDirection: "column", gap: 13 }}>
              {beforeItems.map((b) => (
                <div key={b} style={{ display: "flex", alignItems: "flex-start", gap: 11, font: "500 15px/22px var(--font-inter)", color: "#475569" }}>
                  <span style={{ color: "#CB0000", fontWeight: 700, marginTop: 1 }}>—</span>
                  {b}
                </div>
              ))}
            </div>
          </div>
          <div style={{ background: "#0B1230", borderRadius: 14, padding: 30 }}>
    ...
    <section style={{ background: "#fff", borderTop: "1px solid #EEF2F8", padding: "92px 0" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ maxWidth: 680, marginBottom: 44 }}>
          <div style={{ font: "700 13px var(--font-inter)", color: "#2453D4", marginBottom: 12 }}>The platform</div>
          <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 14 }}>Every part of the consultancy, in one workspace</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }} data-platform="1">
          {platform.map((p) => (
            <Link key={p.title} href={p.href} style={{ textDecoration: "none", background: "#fff", border: "1px solid #E9EEF6", borderRadius: 13, padding: 24, display: "block" }}>
              <span style={{ display: "flex", width: 42, height: 42, borderRadius: 10, alignItems: "center", justifyContent: "center", font: "700 17px var(--font-manrope)", background: p.bg, color: p.fg }}>{p.icon}</span>
              <div style={{ font: "700 17px var(--font-manrope)", color: "#0B1230", margin: "15px 0 7px" }}>{p.title}</div>
...
export function Integrations() {
  return (
    <section style={{ background: "#F6F8FC", padding: "92px 0", borderTop: "1px solid #EEF2F8" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ maxWidth: 680, marginBottom: 40 }}>
          <div style={{ font: "700 13px var(--font-inter)", color: "#2453D4", marginBottom: 12 }}>Automation &amp; integrations</div>
          <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 14 }}>Connect the channels your enquiries already arrive on</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }} data-integ="1">
          {integrations.map((i) => (
            <div key={i.name} style={{ background: "#fff", border: "1px solid #E9EEF6", borderRadius: 11, padding: "18px 18px 16px", position: "relative" }}>
              <span style={{ width: 38, height: 38, borderRadius: 9, background: "#F1F5FB", display: "flex", alignItems: "center", justifyContent: "center", font: "700 14px var(--font-manrope)", color: "#212177" }}>{i.ab}</span>
              <div style={{ font: "700 14.5px var(--font-manrope)", color: "#0B1230", margin: "12px 0 4px" }}>{i.name}</div>
    ...
    <section id="security" style={{ background: "#fff", padding: "92px 0" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ display: "grid", gridTemplateColumns: ".9fr 1.1fr", gap: 48, alignItems: "start" }} data-sec="1">
          <div>
            <div style={{ font: "700 13px var(--font-inter)", color: "#2453D4", marginBottom: 12 }}>Security &amp; trust</div>
            <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 14 }}>Each company gets its own isolated workspace</h2>
            ...
            <Link href="/security" style={{ font: "700 15px var(--font-manrope)", color: "#fff", textDecoration: "none", background: "#212177", padding: "13px 22px", borderRadius: 8, display: "inline-block" }}>Read the security overview →</Link>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            {securityPoints.map((s) => (
              <div key={s.title} style={{ background: "#F6F8FC", border: "1px solid #E9EEF6", borderRadius: 12, padding: 20 }}>
...
export function Migration() {
  return (
    <section style={{ background: "#0B1230", padding: "88px 0" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ maxWidth: 680, marginBottom: 40 }}>
          <div style={{ font: "700 13px var(--font-inter)", color: "#7e8ed4", marginBottom: 12 }}>Migration &amp; onboarding</div>
          <h2 data-h2 style={{ font: "800 38px/45px var(--font-manrope)", letterSpacing: "-.02em", color: "#fff", marginBottom: 14 }}>Move your consultancy across in four steps</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }} data-mig="1">
          {migration.map((m) => (
            <div key={m.n} style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.1)", borderRadius: 13, padding: 24 }}>
              <div style={{ font: "800 16px var(--font-manrope)", color: "#5fd0a6", marginBottom: 14 }}>{m.n}</div>
              <div style={{ font: "700 17px var(--font-manrope)", color: "#fff", marginBottom: 8 }}>{m.title}</div>
...
export function Evidence() {
  const items = [
    { n: "01", bg: "#EEF0FF", fg: "#212177", title: "One connected student record", desc: "Watch a single record move across every team without re-keying." },
    { n: "02", bg: "#EAF0FF", fg: "#2453D4", title: "Workspace isolation, in the product", desc: "See exactly how access is scoped to your company and roles." },
        ...
        <div style={{ background: "#fff", border: "1px solid #E9EEF6", borderRadius: 16, padding: 48, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 44, alignItems: "center" }} data-evid="1">
          <div>
            <div style={{ display: "flex", alignItems: "flex-end", gap: 6, marginBottom: 20 }}>
              <span style={{ width: 7, height: 30, background: "#CB0000", borderRadius: 1 }} />
              <span style={{ width: 5, height: 22, background: "#212177", borderRadius: 1 }} />
              <span style={{ width: 4, height: 14, background: "#CB0000", borderRadius: 1 }} />
            </div>
            <h2 data-h2 style={{ font: "800 32px/40px var(--font-manrope)", letterSpacing: "-.02em", color: "#0B1230", marginBottom: 14 }}>See it on your own workflow before you decide</h2>
            ...
            <Link href="/book-a-demo" style={{ font: "700 15px var(--font-manrope)", color: "#fff", textDecoration: "none", background: "#2453D4", padding: "14px 24px", borderRadius: 8, display: "inline-block" }}>Book a demo</Link>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {items.map((it) => (
              <div key={it.n} style={{ display: "flex", alignItems: "flex-start", gap: 13, background: "#F6F8FC", border: "1px solid #EAEFF7", borderRadius: 11, padding: "16px 18px" }}>
                <span style={{ width: 30, height: 30, flexShrink: 0, borderRadius: 8, background: it.bg, color: it.fg, display: "flex", alignItems: "center", justifyContent: "center", font: "700 12px var(--font-manrope)" }}>{it.n}</span>
                <div>
                  <div style={{ font: "700 14.5px var(--font-manrope)", color: "#0B1230", marginBottom: 2 }}>{it.title}</div>
