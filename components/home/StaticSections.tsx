      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ display: "grid", gridTemplateColumns: ".9fr 1.1fr", gap: 48, alignItems: "start" }} data-sec="1">
          <div>
            ...
            <div style={{ font: "500 12.5px var(--font-inter)", color: "#64748B", marginTop: 16, maxWidth: 380 }}>We describe the controls we operate. We do not claim SOC 2, ISO 27001, or other certifications unless formally verified.</div>
          </div>
