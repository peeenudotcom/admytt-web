...
export default function BookADemoPage() {
  return (
    <PageShell>
      <section style={{ background: "linear-gradient(135deg,#212177 0%,#0B1230 100%)", padding: "72px 0 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 28px", position: "relative", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "start" }} data-demoform="1">
          <div style={{ paddingTop: 8 }}>
            <h1 data-h2 style={{ font: "800 40px/47px var(--font-manrope)", letterSpacing: "-.02em", color: "#fff", marginBottom: 18 }}>See how adMYTT fits the way your consultancy works.</h1>
